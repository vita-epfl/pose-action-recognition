...
def tcg_pad_seqs(list_of_seqs: List[torch.Tensor], mode="replicate", pad_value=0, is_label_seq=False):
    """
...
def tcg_collate_fn(list_of_seqs, padding_mode="replicate", pad_value=0):
    ...
    padded_label = tcg_pad_seqs(label_seq, mode=padding_mode, pad_value=pad_value, is_label_seq=True)
